                    ...
                    <div className="meter">
                        <ul className="meter-list">
                            <li className="meter-item meter-one" style={{ backgroundImage:`linear-gradient(to bottom, orange ,white ` }}>
                                <div className="meter-digit" >{dataHome.light*10} Lux</div>
                                <i className="fa-regular fa-sun"></i>
                                <div className="light">Lights</div>
                            </li>
                            <li className="meter-item" style={{ backgroundImage:`linear-gradient(to bottom, red , white )` }}>
                                <div className="meter-digit" >{dataHome.temperature}Độ C</div>
                                <i className="fa-solid fa-temperature-three-quarters"></i>
                                <div className="temperature">Temperature</div>
                            </li>
                            <li className="meter-item" style={{ backgroundImage:`linear-gradient(to bottom, blue , white )` }}>
                                <div className="meter-digit" >{dataHome.humidity}%</div>
                        ...
                        <ul className="electric-list">
                            <li className="electric-item">
                                <div className="electric-box">
                                    <input checked={turnOn} type="checkbox" className="electric-input" id="electric-input1"></input>
                                   <label for="electric-input1" className="electric-label" onClick ={handleTurnOnLight}></label>
                               </div>
                            ...
                            <li className="electric-item">
                                <div className="electric-box">
                                     <input checked={turnOn1} type="checkbox" className="electric-input" id="electric-input2"></input>
                                    <label for="electric-input2" className="electric-label" onClick={handleTurnOnTemperature}></label>
                                </div>
                                <div className="on-off">
                                    {turnOn1 ? "On" : "Off"}
                                </div>
                            ...
                            <li className="electric-item">
                                <div className="electric-box">
                                    <input checked={turnOn2} type="checkbox" className="electric-input" id="electric-input3"></input>
                                   <label for="electric-input3" className="electric-label" onClick={handleTurnOnAir}></label>
                               </div>
                               <div className="on-off">
                                    {turnOn2 ? "On" : "Off"}
                                </div>
